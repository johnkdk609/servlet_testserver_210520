...
<body>
	<form method="post" action="/lesson02/ex03_1_practice.jsp">
		...
		<label for="pizza">하와이안 피자<input type="checkbox" name="food" id="pizza" value="하와이안 피자"></label>
		<label for="pupa">번데기<input type="checkbox" name="food" id="pizza" value="번데기"></label><br><br>
		5. 좋아하는 과일을 선택하세요.<br>
		<select name="fruit">
			<option>사과</option>
			<option>바나나</option>
