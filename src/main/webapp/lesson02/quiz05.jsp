	...
	<div class="container">
		...
		<form method="post" action="/lesson02/quiz05_1.jsp">
			...
			<div>
				...
				<input type="checkbox" id="inch" name="type" value="inch">
				
				<label for="yard">야드</label>
				<input type="checkbox" id="yard" name="type" value="yard">
				
				<label for="feet">피트</label>
				<input type="checkbox" id="feet" name="type" value="feet">
				
				<label for="meter">미터</label>
				<input type="checkbox" id="meter" name="type" value="meter">
			</div>
